/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts --env-interface Env` (hash: 55fa44577906f23779a0aa2de3794806)
// Runtime types generated with workerd@1.20250913.0 2025-09-16
declare namespace Cloudflare {
	interface Env {
		ALLOWED_DOMAINS: ['example.com'] | ['localhost']
		MASK_DOMAIN: 'https://www.example-mask.com'
